...
class SimulateLogic:
    ...
    def bitwiseAnd(self, operands):
        ...
        print(f'1st oeprand: {firstOperand}, 2nd operand: {secondOperand}')
        for i in range(len(firstOperand)):

#            if secondOperand[i].strip().upper() == "'X'":
#                print('2nd item is X')
#            else:
            print(f'1st item length: {firstOperand[i].strip()}')
            print(f'1st item length: {len(firstOperand[i].strip())}')
            print(f'2nd item length: {secondOperand[i].strip()}')
            print(f'2nd item length: {len(secondOperand[i].strip())}')
            if firstOperand[i].strip() != "'X'" and secondOperand[i].strip() != "'X'":
                bitwiseAnd.append(int(firstOperand[i]) & int(secondOperand[i]))
                
            elif firstOperand[i].strip() != '0' and secondOperand[i].strip() != '0':
                bitwiseAnd.append('X')
    ...
    def bitwiseOr(self, operands):
        ...
        for i in range(len(firstOperand)):
            ...
            elif firstOperand[i].strip() == '1' or secondOperand[i].strip() == '1':
                bitwiseOr.append(1)
